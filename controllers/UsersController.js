...
const handleLogin = async(req, res) => {
    ...
    res.cookie('jwt', newRefreshToken, { httpOnly: true, secure: true, maxAge: 24 * 60 * 60 * 1000, domain: "https://serene-moxie-450fe7.netlify.app/" }) //remove secure for thunder client to be able to test 
        .json({
            accessToken,
            isAdmin,
            user: {
